...
const menu = [
  {
    n: "01",
    name: "Vaschette di Gelato",
    origin: "2 formati",
    desc: "Le nostre vaschette mantecate giornalmente, perfette da portare a casa o condividere con chi ami.",
  },
  {
    n: "02",
    name: "Coppette di Gelato",
    origin: "3 misure",
    desc: "Piccola, media o grande: scegli i gusti tra le nostre creazioni artigianali del giorno.",
  },
  {
    n: "03",
    name: "Vaschette Monogusto 500g",
    origin: "25 gusti",
    desc: "Pistacchio di Bronte, cioccolato di Modica, nocciola, frutta di stagione e tanto altro.",
  },
  {
    n: "04",
    name: "Brioches col Tuppo",
    origin: "Tradizione",
    desc: "La brioche siciliana soffice e profumata, l'unico modo autentico di gustare il gelato.",
  },
  {
    n: "05",
    name: "Crêpes & Waffel",
    origin: "Caldi",
    desc: "Crêpes fragranti e waffel croccanti farciti con gelato, nutella e topping a scelta.",
  },
  {
    n: "06",
    name: "Pokè Gelato",
    origin: "Signature",
    desc: "Base waffle, gelato a scelta e nutella. La nostra reinterpretazione golosa del bowl.",
  },
  {
    n: "07",
    name: "Coni Mignon & Coppette di Panna",
    origin: "Sfiziosi",
    desc: "Piccoli formati per concedersi una pausa dolce, con panna fresca montata al momento.",
  },
  {
    n: "08",
    name: "Bevande",
    origin: "9 referenze",
    desc: "Acqua, bibite, birre e una selezione di bevande fresche per accompagnare il dessert.",
  },
];
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 flex flex-wrap gap-3">
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Dolce%20Capo%20Gelateria%2C%20Via%20dei%20Candelai%2095%2F97%2C%2090134%20Palermo%20PA"
                  target="_blank"
